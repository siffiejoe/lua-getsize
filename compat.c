...
static GetArgFunction const getArgFuncs[] = {
  ...
  getArg_50400, getArg_50400, getArg_50400, getArg_50400
#else
...
#elif LUA_VERSION_NUM == 504
  sizeBoolean_50400, sizeBoolean_50400, sizeBoolean_50400, sizeBoolean_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeNumber_50400, sizeNumber_50400, sizeNumber_50400, sizeNumber_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeString_50400, sizeString_50400, sizeString_50400, sizeString_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeFunction_50400, sizeFunction_50400, sizeFunction_50400, sizeFunction_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  tableNode_50400, tableNode_50400, tableNode_50400, tableNode_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeTable_50400, sizeTable_50400, sizeTable_50400, sizeTable_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeUserdata_50400, sizeUserdata_50400, sizeUserdata_50400, sizeUserdata_50400
#else
#error unsupported Lua version
#endif
};
...
#elif LUA_VERSION_NUM == 504
  sizeThread_50400, sizeThread_50401, sizeThread_50402, sizeThread_50403
#else
#error unsupported Lua version
#endif
};
